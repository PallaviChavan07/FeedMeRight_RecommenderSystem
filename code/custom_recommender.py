...
if len(recipes_to_ignore_list) < 1 or isNewUser:
    ...
    print(cb_final_top10_recommendation_df[list_of_cols_to_display])
    ...
    print(cf_final_top10_recommendation_df[list_of_cols_to_display])
    ...
    print(hybrid_final_top10_recommendation_df[list_of_cols_to_display])
