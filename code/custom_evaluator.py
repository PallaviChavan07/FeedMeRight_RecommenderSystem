...
class ModelEvaluator:
    ...
    def evaluate_model_for_user_enchanced(self, model, user_id, k=5):
    ...
    def evaluate_model(self, model):
        ...
        for idx, user_id in enumerate(list(self.interactions_full_indexed_df.index.unique().values)):
            ...
            singleuser_metric = self.evaluate_model_for_user_enchanced(model, user_id, k=5)
        ...
        global_metrics = {'model': model.get_model_name(), 'recall@5': global_recall, 'precision@5': global_precision, 'accuracy@5': global_accuracy}
